"""
Assembles experiments_v6/report/index.html (v2) -- a single, self-contained
...
existing repo file (dataset CSVs, experiments_v6/results/*.csv,
experiments_v6/report/{examples,journey}.json) or copied verbatim from a
...
nh_header, nh_rows = read_csv_rows(REPO_ROOT / "experiments_v3" / "data" / "nhanes_real.csv", 5)

journey_path = HERE / "journey.json"
...
pref_csv = REPO_ROOT / "experiments_v6" / "results" / "preference_demo.csv"
pref_rows = []
if pref_csv.exists():
...
fig_specs = [
    (REPO_ROOT / "experiments_v3" / "figures" / "figA_ablation_bars.png",
    ...
    (REPO_ROOT / "experiments_v3" / "figures" / "figB_abstention_decomposition.png",
    ...
    (REPO_ROOT / "experiments_v5" / "figures" / "fig1_motivating_gap.png",
...
<section id="pipeline">
  ...
  {PIPELINE_SVG}
  <p class="source">Source: src/graph/calg.py, src/graph/riemannian.py, experiments_v6/lib/graph_build.py, experiments_v6/lib/neurosymbolic.py, experiments_v6/lib/explanations.py, experiments_v6/ui/</p>
</section>

<section id="journey">
  <h2><span class="num">4</span>The patient journey</h2>
  <p>Two real UCI test patients (seed 0), pulled directly from <code>experiments_v6/results/uci_per_patient.csv</code>
  ...
  these two specific, already-identified patients (see <code>experiments_v6/report/collect_journey.py</code>).
  Scroll down to follow the risk score drop and the reasoning accumulate, layer by layer.</p>
  {journey_html}
  <p class="source">Source: experiments_v6/results/uci_per_patient.csv (patient identification); experiments_v6/lib/graph_build.py, neurosymbolic.py, explanations.py (all computation); experiments_v6/report/journey.json (captured output)</p>
</section>
...
<section id="b1b2">
  ...
  <code>experiments_v6_audit/DEEP_AUDIT.md</code> issue #5): under the corrected gate, roughly
  ...
  result.</p>
  <p class="source">Source: experiments_v6_audit/RECOMMENDATION.md (pre-fix numbers, root-cause evidence); experiments_v6/FINDINGS.md, section &ldquo;Phase 1 — the corrected foundation&rdquo; (post-fix numbers, full 5-seed grid)</p>
</section>
...
<section id="core-assumption">
  ...
  <p class="source">Source: experiments_v6/METHOD.md, &ldquo;Core Assumption&rdquo; (added per experiments_v6_audit/DEEP_AUDIT.md issue #6)</p>
</section>
...
<section id="classifier-audit">
  ...
  this project.</p>
  <p class="source">Source: experiments_v6/CLASSIFIER_AUDIT.md; experiments_v6/results/classifier_audit.json</p>
</section>
...
<section id="neurosymbolic">
  ...
  (<code>experiments_v6_audit/DEEP_AUDIT.md</code> issue #8); they are now wired into the UI for real
  ...
  <p class="source">Source: experiments_v6/lib/neurosymbolic.py; experiments_v6/run_neurosymbolic_regression.py; experiments_v6/FINDINGS.md, section &ldquo;Phase 4&rdquo;; src/recourse/explanations.py::nhanes_guideline_context</p>
</section>
...
<section id="infeasibility">
  ...
  <code>experiments_v6_audit/DEEP_AUDIT.md</code> issue #7): the SAME densification-probe methodology
  ...
  {semifactual_html}
  <p class="source">Source: experiments_v6/FINDINGS.md, section &ldquo;Phase 2&rdquo;; experiments_v6/results/{{dataset}}_blindspot_seed_summary.csv; examples regenerated via experiments_v6/report/collect_examples.py from experiments_v6/lib/explanations.py (unmodified)</p>
</section>
...
<section id="preference">
  ...
  {pref_html}
  <p>Honest finding (from experiments_v6/FINDINGS.md, not smoothed over): the selected target changed
  ...
  <p class="source">Source: experiments_v6/results/preference_demo.csv; experiments_v6/FINDINGS.md, section &ldquo;Phase 6&rdquo;</p>
</section>
...
<section id="benchmarks">
  ...
  <p class="source">Source: experiments_v6/FINDINGS.md, section &ldquo;Phase 8&rdquo;; experiments_v6/results/face_rerun_per_patient.csv, pace_reimpl_per_patient.csv; PACE's own numbers read directly from arXiv:2607.01306, Table 4</p>
</section>
