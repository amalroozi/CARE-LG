...
E+none, DiCE, FACE, REVISE, GrowingSpheres. Unlike experiments_v2, REVISE is
now genuinely implemented (experiments_v3/lib/revise.py) and run under the
same protocol as every other row -- see CHANGES.md for hyperparameters.
GrowingSpheres is kept as an extra row (not a substitute for anything).
"""
import sys
...
ROW_SPEC = [
    ...
    ("DiCE", "DiCE"),
    ("FACE", "FACE"),
    ("REVISE", "REVISE (genuinely implemented, this session)"),
