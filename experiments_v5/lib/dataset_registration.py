...
# The real NHANES cohort built in experiments_v3 (Phase A) is REUSED READ-ONLY here.
# v4 does not rebuild or modify it -- see experiments_v3/DATA_PROVENANCE.md for its
# full construction, and Hard Rule 3 (experiments_v3/ must not be modified).
